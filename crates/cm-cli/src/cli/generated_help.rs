...
#![allow(clippy::all)]
#[rustfmt::skip]
pub const RECALL_ABOUT: &str = "Recall priority context for a single known scope.\n\nWalks the target scope and its ancestors. Use search for descendants, set, or all-scope content search.";
#[rustfmt::skip]
pub const RECALL_QUERY_HELP: &str = "FTS5 search query (prefix: rust*, phrase: \"scope path\", boolean: AND/OR/NOT)";
#[rustfmt::skip]
pub const RECALL_SCOPE_HELP: &str = "Scope selector: exact path, cwd_inferred, or structured singular JSON. Default: global";
#[rustfmt::skip]
...
#[rustfmt::skip]
pub const SEARCH_ABOUT: &str = "Search cm entries by content across scopes.\n\nReturns FTS5 BM25-ranked hits. Use for multiple scopes, unknown scope, descendants, set, or all-scope searches.";
#[rustfmt::skip]
pub const SEARCH_QUERY_HELP: &str = "Required FTS5 search query";
#[rustfmt::skip]
pub const SEARCH_SCOPE_HELP: &str = "Scope selector: exact path, cwd_inferred, or structured descendants/set/all JSON";
#[rustfmt::skip]
...
#[rustfmt::skip]
pub const STORE_SCOPE_HELP: &str = "Target scope: exact path, cwd_inferred, or structured singular JSON. Default: global";
#[rustfmt::skip]
...
#[rustfmt::skip]
pub const DEPOSIT_SCOPE_HELP: &str = "Target scope: exact path, cwd_inferred, or structured singular JSON. Default: global";
#[rustfmt::skip]
...
#[rustfmt::skip]
pub const BROWSE_SCOPE_HELP: &str = "Preferred scope: cwd_inferred, exact path, or structured descendants/set/all selector";
#[rustfmt::skip]
...
#[rustfmt::skip]
pub const EXPORT_SCOPE_HELP: &str = "Filter export scope: exact path, cwd_inferred, or structured descendants/set/all JSON";
#[rustfmt::skip]
