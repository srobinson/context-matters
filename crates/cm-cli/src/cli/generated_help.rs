...
#[rustfmt::skip]
pub const RECALL_SCOPE_HELP: &str = "Scope selector: structured path/cwd_inferred JSON; reserved value cwd_inferred means cwd inference. Default: global";
#[rustfmt::skip]
